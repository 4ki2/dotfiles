...
alias dsprune="docker system prune --all --volumes"
alias dc="docker compose"
alias dck="docker compose stop"
alias dcstop="docker compose stop"
alias dcb="docker compose build"
alias dcbuild="docker compose build"
alias dcrebuild="docker compose build --progress plain --no-cache"
...
#alias dvrmall="docker volume rm $(docker volume ls -qf dangling=true)"

alias dvprune="docker volume ls -qf dangling=true | xargs -r docker volume rm"
